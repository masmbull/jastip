...
<footer class="bg-[#2D2D2D] text-[#F5F5F5]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div class="space-y-4">
                <div class="flex items-center space-x-3">
                    ...
                    @else
                        <div class="h-10 w-10 rounded-full bg-rose-300 flex items-center justify-center">
                            <span class="text-[#2D2D2D] font-bold text-lg">N</span>
                        </div>
                    @endif
                    <div>
                        <span class="font-bold text-xl text-white">{{ $brandName }}</span>
                        <span class="block text-xs text-rose-300">{{ $brandTagline }}</span>
                    </div>
                </div>
                <p class="text-sm text-[#CCCCCC]">by {{ $brandOwner }}</p>
                                <p class="text-sm text-[#999999]">Nitip lokal sebandar, cepat, dan terpercaya.</p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex items-start space-x-3">
                        <svg class="w-5 h-5 text-rose-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-4">
                    <a href="https://instagram.com/{{ $instagram }}" target="_blank" rel="noopener"
                       class="w-10 h-10 bg-[#3A3A3A] rounded-full flex items-center justify-center text-rose-400 hover:bg-rose-500 hover:text-white transition-colors">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('home') }}" class="text-[#CCCCCC] hover:text-rose-400 transition-colors">Beranda</a></li>
                    <li><a href="{{ route('products.index') }}" class="text-[#CCCCCC] hover:text-rose-400 transition-colors">Semua Produk</a></li>
                    <li><a href="{{ route('categories.index') }}" class="text-[#CCCCCC] hover:text-rose-400 transition-colors">Kategori</a></li>
                    <li><a href="{{ route('about') }}" class="text-[#CCCCCC] hover:text-rose-400 transition-colors">Tentang</a></li>
                    <li><a href="{{ route('how-to') }}" class="text-[#CCCCCC] hover:text-rose-400 transition-colors">Cara Nitip</a></li>
                    <li><a href="{{ route('contact') }}" class="text-[#CCCCCC] hover:text-rose-400 transition-colors">Kontak</a></li>
                </ul>
            </div>
        </div>
