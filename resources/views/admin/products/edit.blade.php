...
<div class="p-6 space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-[#333333]">Edit Produk</h1>
    ...
    <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data"
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="4" required
                    class="w-full px-4 py-3 border border-[#E8E0D8] rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-300 @error('description') border-red-500 @enderror">{{ old('description', $product->description) }}</textarea>
        ...
        <div>
            ...
            <div class="mt-3 flex items-center gap-4">
                ...
                <span class="text-xs text-[#999999]">Ganti foto dengan upload foto baru (biarkan kosong jika tidak ingin mengganti).</span>
            </div>
        </div>
