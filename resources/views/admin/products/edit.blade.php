        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="setbiaya_fee" value="{{ old('setbiaya_fee', $product->setbiaya_fee ?? 0) }}" min="0"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-[#1E293B] mb-1">SKU</label>
