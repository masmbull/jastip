...
<div class="p-6 space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-[#333333]">Tambah Kategori</h1>
    ...
    <form method="POST" action="{{ route('admin.categories.store') }}"
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-[#999999] mt-1">Biarkan kosong untuk membuat otomatis dari nama.</p>
            ...
            <div>
                ...
                <textarea name="description" rows="2"
                    class="w-full px-4 py-3 border border-[#E8E0D8] rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-300">{{ old('description') }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" name="icon" value="{{ old('icon') }}"
                    ...
                    class="w-full px-4 py-3 border border-[#E8E0D8] rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-300">
                <p class="text-xs text-[#999999] mt-1">Contoh: 🧴 untuk Parfum, 🥤 untuk Tumbler, dll.</p>
            </div>
